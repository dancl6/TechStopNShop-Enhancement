  ...
  function displayCart() {
    ...
    for(var i in cartArray) {
      output += "<tr>"
        ...
        + "<td><div class='input-group'><div class='minus-item input-group-addon btn btn-primary' data-name= '" + cartArray[i].name + "'></div>"
        + "<div type='number' class='item-count form-control' data-name='" + cartArray[i].name + "' value='" + cartArray[i].count + "'>"
        + "<div class='plus-item btn btn-primary input-group-addon' data-name= '" + cartArray[i].name + "'></div></div></td>"
